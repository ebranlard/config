...
" syn keyword masterKeyword \-nowaves \-noquake \-nowind 
" syn keyword masterKeyword Nowaves Noquake Nowind 

" String
syn match  masterString	"^.*\.bld"
syn match  masterString	"^.*\.brk"
syn match  masterString	"^.*\.con"
syn match  masterString	"^.*\.fnd"
syn match  masterString	"^.*\.gen"
syn match  masterString	"^.*\.pit"
syn match  masterString	"^.*\.twr"
syn match  masterString	"^.*\.yaw"
