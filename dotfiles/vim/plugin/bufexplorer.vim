...
if !hasmapto('BufExplorer')
    noremap <script> <silent> <unique> \be :BufExplorer<CR>
endif

if !hasmapto('BufExplorerHorizontalSplit')
    noremap <script> <silent> <unique> \bs :BufExplorerHorizontalSplit<CR>
endif

if !hasmapto('BufExplorerVerticalSplit')
    noremap <script> <silent> <unique> \bv :BufExplorerVerticalSplit<CR>
endif
